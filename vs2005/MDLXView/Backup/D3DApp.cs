...
public class GraphicsSample : System.Windows.Forms.Form
{
    ...
    protected SamplerStateManager sampleState;
    protected TextureStateManager textureStates;
...
EndFullscreenDeviceComboSearch:
    ...
    public void InitializeEnvironment()
    {
        ...
        try
        {
            ...
            sampleState = device.SamplerState[0];
            textureStates = device.TextureState[0];
